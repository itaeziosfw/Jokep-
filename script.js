...
const playHuman = (humanChoice) => {
    ...
    if (humanChoice === 'paper') {
        humanImage.src = 'img/paper_left.png';
    } else if (humanChoice === 'rock') {
        humanImage.src = 'img/rock_left.png';
    } else {
        humanImage.src = 'img/scissors_left.png';
    }
...
const playTheGame = (human, machine) => {
    ...
    if (machine === 'paper') {
        machineImage.src = 'img/paper_rigth.png';
    } else if (machine === 'rock') {
        machineImage.src = 'img/rock_rigth.png';
    } else {
        machineImage.src = 'img/scissors_rigth.png';
    }
}